...
def chargeTrail(det,E_in, E_out, x_in, x_out, y_in, y_out, z_in, z_out, t_in, t_out):
    """
    ...
    a single charge. The modelled charge is placed in the middle of the segment and its signal response 
    is calculated using the function Signal
    ...
    for i in range(0,num_seg):
        ...
        #print('\nr: ',np.sqrt(x**2))
        #input()
        I,sigs,t_sig=signal(det,mu_e=det.Mob,mu_i=det.mu_i,x=x,y=y,z=z,dr=1e-4,q=q_dL,t_start=t)
